...
app.get('/team_stats', function(req, res) {
	var getGamesQuery = 'select * from football_games;';
	var winsQuery = 'select * from football_games where home_score>visitor_score;';
	var lossesQuery = 'select * from football_games where home_score<visitor_score;';
	db.task('get-everything', task => {
		return task.batch([
			task.any(getGamesQuery),
			task.any(winsQuery),
			task.any(lossesQuery)
		]);
	})
	.then(data => {
...
app.get('/player_info', function(req, res) {
	var playersQuery = 'select * from football_players;';
	db.any(playersQuery)
	.then(function (rows) {
...
app.get('/player_info/post', function(req, res) {
	...
	var playersQuery = 'select * from football_players;';
	var thisPlayer = 'select * from football_players where id=\''+player_choice+'\';';
	var gamesIn = 'select * from football_games where \''+player_choice+'\'=any(players);';
	db.task('get-everything', task => {
		return task.batch([
